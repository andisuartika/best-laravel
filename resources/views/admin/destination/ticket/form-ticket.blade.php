<x-layout.default>
    ...
    <div>
        ...
        <div
            ...
            <span class="ltr:mr-3 rtl:ml-3">Tiket Destinasi Wisata: </span>Harga tiket destinasi wisata
        </div>
                ...
                <div class="panel p-5">
                    <div>
                        <h4 class="mb-4 text-2xl font-semibold">
                            @if (isset($ticket))
                                Ubah
                            @endif Tiket Destinasi Wisata
                        </h4>
                        <p class="mb-4">
                            Silahkan lengkapi form berikut untuk
                            menambah tiket destinasi wisata
                        </p>
                        <div>
                            <form class="space-y-5" method="POST"
                                ...
                                <div class=" @error('description')  has-error @enderror">
                                    ...
                                    <textarea id="editor" name="description">{{ isset($ticket) ? $ticket->description : old('description') }}</textarea>
                                ...
                                <div class=" @error('price')  has-error @enderror">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="text" placeholder="Masukkan Harga Tiket"
                                            ...
                                            value="{{ isset($ticket) ? rtrim(rtrim($ticket->price, '0'), '.') : old('price') }}"
                                            required />
                                    </div>
                                    @error('price')
                                        <div class="text-danger mt-1">{{ $message }}</div>
