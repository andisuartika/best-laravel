                    ...
                    <div>
                        ...
                        <p class="mb-4">
                            @if (isset($type))
                                ...
                                mengubah tipe kamar penginapan
                            @else
                                Silahkan lengkapi form berikut untuk
                                menambah tipe kamar penginapan
                            @endif

                        </p>
                        <div>
                            <form class="space-y-5" method="POST"
                                action="{{ isset($type) ? route('room-type.update', $type) : route('room-type.store') }}"
                                ...
                                <div class=" @error('name')  has-error @enderror">
                                    ...
                                    <input id="name" name="name" type="text" required
                                        placeholder="Masukkan Nama Tipe Kamar" class="form-input"
                                ...
                                <div class=" @error('description')  has-error @enderror">
                                    ...
                                    <textarea id="editor" name="description">{{ isset($type) ? $type->description : old('description') }}</textarea>
                                ...
                                <div class=" @error('capacity')  has-error @enderror">
                                    <label for="capacity">Kapasitas Kamar</label>
                                    <input id="capacity" name="capacity" type="number" required
                                        placeholder="Masukkan Kapasitas Kamar" class="form-input"
                                        value="{{ isset($type) ? $type->capacity : old('capacity') }}" />
                                    @error('capacity')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="@error('facilities') has-error @enderror">
                                    <label for="facilities">Fasilitas Tipe Kamar</label>
                                    <select class="facilitySelect form-select form-select-lg text-white-dark"
                                        ...
                                        @if (isset($type))
                                            @php
                                                ...
                                                $selectedFacilities = json_decode($type->facilities);
                                            @endphp
                                ...
                                <div class="@error('thumbnail')  has-error @enderror">
                                    ...
                                    <div class="py-5">
                                        <img id="preview"
                                            src="{{ isset($type) ? asset($type->thumbnail) : asset('assets/images/file-preview.svg') }}"
