    ...
    <div>
        <ul class="flex space-x-2 rtl:space-x-reverse">
            ...
            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                <span>Daftar Desa Wisata Wisata</span>
            </li>
        </ul>
        <div
            ...
            <span class="ltr:mr-3 rtl:ml-3">Desa Wisata: </span>Daftar Desa Wisata
        </div>
        <div class="panel p-0 flex-1">
            <div class="md:flex items-center flex-wrap p-4 border-b border-[#ebedf2] dark:border-[#191e3a]">
                ...
                <div class="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
                    ...
                    <div class="relative ">
                        <form method="GET">
                            <input type="text" name="search" placeholder="Cari Desa Wisata"
                        ...
                        <table class="table-striped table-hover">
                            ...
                            <tbody>
                                @foreach ($villages as $village)
                                    <tr>
                                        <td>
                                            <div>{{ $village->village()->get()->implode('name') }}</div>
                                        </td>
                                        <td>{{ $village->name }}</td>
                                        <td>{{ $village->email }}</td>
                                        <td>{{ $village->phone }}</td>
