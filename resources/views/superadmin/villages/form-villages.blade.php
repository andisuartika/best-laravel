<x-layout.default>
    ...
    <div>
        <ul class="flex space-x-2 rtl:space-x-reverse">
            <li>
                <a href="{{ route('villages.index') }}" class="text-primary hover:underline">Desa Wisata</a>
            </li>
            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                <span>Tambah Desa Wisata</span>
            </li>
        </ul>
        <div
            ...
            <span class="ltr:mr-3 rtl:ml-3">Desa Wisata: </span> @if (isset($user))
           Ubah
        @else
            Tambah
        @endif Desa Wisata
                    ...
                    <div>
                        ...
                        <p class="mb-4">
                            @if (isset($user))
                                ...
                                mengubah desa wisata
                            @else
                                Silahkan lengkapi form berikut untuk
                                menambah desa wisata
                            @endif

                        </p>
                        <div>
                            <form class="space-y-5" method="POST"
                                action="{{ isset($user) ? route('update.village', $user) : route('villages.store') }}"
                                ...
                                @endif
                                @if (!isset($user))
                                <div class="@error('village')  has-error @enderror">
                                    <label for="village">Pilih Desa</label>
                                    <select class="villageSelect selectize form-select form-select-lg text-white-dark"
                                        name="village">
                                ...
                                <div class=" @error('name')  has-error @enderror">
                                    <label for="name">Desa Wisata</label>
                                    <input id="name" name="name" type="text"
                                         class="form-input"
                                        value="{{  $user->village()->get()->implode('name') }}" disabled/>
                                </div>
                                @endif
                                <div class=" @error('name')  has-error @enderror">
                                    <label for="name">Pengelola Desa</label>
                                    <input id="name" name="name" type="text" required
                                        placeholder="Masukkan Pengelola Desa Wisata" class="form-input"
                                ...
                                <div class=" @error('email')  has-error @enderror">
                                    ...
                                    <input id="email" name="email" type="email" required
                                        placeholder="Masukkan Alamat Email" class="form-input"
                                ...
                                <div class=" @error('phone')  has-error @enderror">
                                    ...
                                    <input id="phone" name="phone" type="text" required
                                        placeholder="Masukkan Nomor Telp" class="form-input"
                                ...
                                <div class=" @error('address')  has-error @enderror">
                                    ...
                                    <input id="address" name="address" type="text" required
                                        placeholder="Masukkan Alamat Kantor" class="form-input"
                                ...
                                <div class=" @error('password_confirmation')  has-error @enderror">
                                    <label for="password_confirmation">Konfirmasi Password</label>
                                    <input id="password_confirmation" name="password_confirmation" type="password" required
                                        placeholder="Masukkan Konfirmasi Password" class="form-input"/>
