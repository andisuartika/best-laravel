  ...
  <div class="max-w-6xl mx-auto px-4 py-8 font-sans">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <div class="lg:col-span-2 bg-white rounded-lg border border-gray-200 shadow-sm p-6">
        <form action="{{ route('destination.booking.store') }}" method="POST">
            @csrf
      ...
      <div>
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="p-4">
                ...
                <img src="{{ asset($destination->thumbnail) }}" alt="Dufan" class="w-16 h-16 rounded-md object-cover">
                <div>
                    <h2 class="text-base font-bold text-gray-800">{{ $destination->name }}</h2>
